---
aliases: ["Calendário Geral 3 Posts", "Entregável b Atv2"]
tags: [senai, calendario, funil, atividade2, obsidian]
cssclass: clean
created: 2026-08-29
updated: 2026-08-29
...
```mermaid
flowchart LR
    A[Post1 Topo<br>Reels Dopamina<br>Segunda 18h] --> B[Post2 Meio<br>Carrossel Reciprocidade/Ancoragem<br>Quarta 19h]
    B --> C[Post3 Fundo<br>WhatsApp+Feira Escassez<br>Sábado 08h]
    C --> D[Meta +20%<br>Vendas digitais]
```
