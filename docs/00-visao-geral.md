---
aliases: ["Visão Geral Atividade 1", "Resumo - Persona e Experiência"]
tags: [senai, marketing-digital, ia, persona, experiencia-cliente, atividade1, visao-geral, obsidian]
cssclass: clean
created: 2026-08-29
updated: 2026-08-29
source: Atividade_1_Aluno_Persona_e_Experiencia_do_Cliente.docx
prev: "[[README|README]]"
next: "[[01-instrucoes-e-capacidades|01 — Instruções e Capacidades]]"
---
...
- **Capacidades mobilizadas:** `CT2, CT4, CSE1, CSE2` → detalhes em [[01-instrucoes-e-capacidades#1.2 Quadro 1 — Capacidades Mobilizadas (cópia fiel)|Quadro 1]]. Atv2 mobiliza `CT1,CT4,CSE2,CSE3` — ver `[[08-visao-geral-atv2]]`. Atv3 mobiliza `CT3,CT5,CT6,CSE1,CSE3` — ver `[[14-visao-geral-atv3|14 — Visão Geral Atv3]]`.
...
```mermaid
flowchart LR
    A[Atv1 Manhã<br>Personas+Jornada+ML<br>CT2,CSE1] --> B[Atv2 Tarde 14-16h<br>Gatilhos+Calendário S1/S2<br>CT1,CSE3]
    B --> C[Atv3 Tarde 16h15-18h<br>Criativos+KPIs+Ética<br>CT3,CT5,CT6]
```
...
```mermaid
flowchart LR
    A[01 Instruções] --> B[02 Perfil Grão Vivo]
    B --> C[03 Cronograma]
    C --> D[04 Tarefas a–f]
    D --> E[05 Entregável]
    E --> F[06 Avaliação]
