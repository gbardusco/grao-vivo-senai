...
- **Curso:** Aperfeiçoamento Profissional Marketing Digital com IA — SENAI-SP (Plano de curso 2024) — `Atividade_1_...docx:49`
- **Sessão:** Encerramento (8h) — esta é a **Atividade 1 da manhã** (3h15). Ver [[03-cronograma]] para o dia completo.
- **Capacidades mobilizadas:** `CT2, CT4, CSE1, CSE2` → detalhes em [[01-instrucoes-e-capacidades#1.2 Quadro 1 — Capacidades Mobilizadas (cópia fiel)|Quadro 1]]
